...
import { EmailConfirmationContainer as EmailConfirmation } from '../pages/EmailConfirmation/Container';
  ...
  return (
    <BrowserRouter>
      ...
      <Switch>
        ...
        <Route path="/confirm-email/:key" exact component={EmailConfirmation} />
